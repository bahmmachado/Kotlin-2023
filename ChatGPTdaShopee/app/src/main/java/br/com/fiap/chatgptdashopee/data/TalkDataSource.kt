...
object TalkDataSource {
    val talkList: List<TalkModel> = listOf(
        TalkModel(
            ...
            listOf(
                AnswerModel("Mércurio é o planeta mais próximo do sol.", true),
                AnswerModel("Por ser muito próximo do sol, Mércurio é conhecido como planeta vermelho, pois é um planeta muito quente."),
                AnswerModel("Distância do Sol: 57.910.00 de quilômetros."),
                AnswerModel("Massa: 3.302x1023 kg (330 bilhôes de bilhôes de toneladas).")
            )
        ),
        TalkModel(
            "O que é Kotlin?",
            listOf(
                AnswerModel("Kotlin é uma linguagem de programação multiplataforma, orientada a objetos e funcional, conciesa e estaticamente tipada, desenvolvida pela JetBrains em 2011."),
                ...
                AnswerModel("Com a nulidade inclusa no sistema de tipo, o Kotlin ajuda a evitar NullPointerExceptions. Os apps Android que usam código Kotlin têm 2-0% menos chances de apresentar falhas. "),
